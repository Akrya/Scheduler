...
public class GraphViewCreator {
    ...
    /**
     * Initialises the properties of the main.graph.
     */
    public GraphViewCreator(){
        graph = GraphTools.defaultGraph(graph,Main.getController().getGraphFilename());
     ...
     * @return swingNode used to embed the main.graph visual into the JavaFX scene.
     */
