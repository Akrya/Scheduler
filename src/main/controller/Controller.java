...
public class Controller {
    ...
    /**
     * Method that handles the parsing of the dot file and makes a main.main.graph object using the
    ...
    private void printInputArgumentsError() {
        ...
        System.out.println("INPUT. dot   a task main.main.graph with integer weights in dot format");
        System.out.println("P            number of  processors  to  schedule  the INPUT main.main.graph on");
